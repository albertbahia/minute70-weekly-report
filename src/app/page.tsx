  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center px-6">
        {/* Hero */}
        <section className="w-full max-w-2xl text-center pt-20 sm:pt-28 pb-16 space-y-6">
          ...
          <div className="pt-2">
            <Link
              href="/weekly-report"
              className="inline-block w-full sm:w-auto rounded-2xl bg-[var(--primary)] text-white font-semibold px-10 py-4 text-lg hover:brightness-110 transition-all duration-200 shadow-[0_4px_14px_-2px_rgba(26,122,107,0.3)]"
            >
        ...
        {/* How it works */}
        <section className="w-full max-w-2xl py-16 border-t border-[var(--border)]">
          ...
          <div className="grid sm:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={item.step} className="space-y-3">
                <span className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-[var(--primary)] text-white font-bold text-sm">
                  {item.step}
                </span>
        ...
        <section className="w-full max-w-2xl py-16 border-t border-[var(--border)]">
          ...
          <div className="max-w-lg mx-auto rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 space-y-5 shadow-[var(--card-shadow)]">
        ...
        {/* Bottom CTA */}
        <section className="w-full max-w-2xl py-16 border-t border-[var(--border)] text-center space-y-4">
